...
def parse_agrs():
    ...
    parser.add_argument('--h5_dir', type=str, default='.../pt_files', help='the path to the directory containing the encoded wsi patches using UNI.')
    parser.add_argument('--image_dir2', type=str, default='.../pt_files', help='the path to the directory containing the encoded wsi patches using UNI.')
    ...
    parser.add_argument('--start_val', type=int, default=40, help='start eval epochs')
